    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="mb-3" align="right">
          <a href="?page=manage-product" class="btn btn-primary">Add Product</a>
        </div>
              ...
              <?php foreach ($rows as $key => $data): ?>
                <tr>
                  ...
                  <td>
                    ...
                    Major</a> -->
                    <a href="?page=manage-product&edit=<?php echo $data['id'] ?>" class="btn btn-primary">Edit</a>
                    <a onclick="return confirm('Are You Sure...?')"
                      href="?page=manage-product&delete=<?php echo $data['id'] ?>" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
